...
export type ImportedSocialVideosQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  before?: InputMaybe<Scalars['Cursor']['input']>;
  after?: InputMaybe<Scalars['Cursor']['input']>;
...
export type ImportedSocialVideosQuery = { __typename?: 'Query', importedVideos: { __typename?: 'ImportedVideoConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', startCursor?: any | null, endCursor?: any | null, hasNextPage: boolean, hasPreviousPage: boolean }, edges?: Array<{ __typename?: 'ImportedVideoEdge', node?: { __typename?: 'ImportedVideo', id: string, bucket?: string | null, storageKey?: string | null, title?: string | null, body?: string | null, exportStatus?: ImportedVideoExportStatus | null, accountConnectionID: string, exportedVideo?: { __typename?: 'Video', id: string, post?: { __typename?: 'Post', id: string } | null } | null } | null } | null> | null } };
...
export type CurrentUserQuery = { __typename?: 'Query', currentUser: { __typename?: 'User', id: string, email?: string | null, firstName?: string | null, lastName?: string | null, role: UserRole, username?: string | null, limitedRoles?: Array<string> | null, credential?: string | null, tenants?: Array<{ __typename?: 'Tenant', id: string, name: string, default: boolean }> | null, profileImage?: { __typename?: 'Image', url?: string | null } | null, avatar?: { __typename?: 'MediaItem', url: string, publicID: string } | null } };

export type CreateInstagramConnectionMutationVariables = Exact<{
  username: Scalars['String']['input'];
}>;


export type CreateInstagramConnectionMutation = { __typename?: 'Mutation', createInstagramConnection?: { __typename?: 'AccountConnection', id: string } | null };

export type CreateYoutubeConnectionMutationVariables = Exact<{
  username: Scalars['String']['input'];
}>;


export type CreateYoutubeConnectionMutation = { __typename?: 'Mutation', createYoutubeConnection?: { __typename?: 'AccountConnection', id: string } | null };

export type AccountConnectionsQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  before?: InputMaybe<Scalars['Cursor']['input']>;
  after?: InputMaybe<Scalars['Cursor']['input']>;
...
export type RefreshInstagramConnectionMutation = { __typename?: 'Mutation', refreshInstagramConnection?: { __typename?: 'AccountConnection', id: string } | null };

export type RefreshTiktokConnectionMutationVariables = Exact<{
  id: Scalars['Int']['input'];
}>;


export type RefreshTiktokConnectionMutation = { __typename?: 'Mutation', refreshTiktokConnection?: { __typename?: 'AccountConnection', id: string } | null };

export type RefreshYoutubeConnectionMutationVariables = Exact<{
  id: Scalars['Int']['input'];
}>;


export type RefreshYoutubeConnectionMutation = { __typename?: 'Mutation', refreshYoutubeConnection?: { __typename?: 'AccountConnection', id: string } | null };

export type CreatePostsFromConnectionMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;
...
export const ImportedSocialVideosDocument = new TypedDocumentString(`
    query ImportedSocialVideos($first: Int, $last: Int, $before: Cursor, $after: Cursor, $where: ImportedVideoWhereInput) {
  importedVideos(
    first: $first
    last: $last
    before: $before
    ...
    `) as unknown as TypedDocumentString<ImportedSocialVideosQuery, ImportedSocialVideosQueryVariables>;
...
export const CreateInstagramConnectionDocument = new TypedDocumentString(`
    mutation CreateInstagramConnection($username: String!) {
  createInstagramConnection(username: $username) {
    id
  }
}
    `) as unknown as TypedDocumentString<CreateInstagramConnectionMutation, CreateInstagramConnectionMutationVariables>;
export const CreateYoutubeConnectionDocument = new TypedDocumentString(`
    mutation CreateYoutubeConnection($username: String!) {
  createYoutubeConnection(username: $username) {
    id
  }
}
    `) as unknown as TypedDocumentString<CreateYoutubeConnectionMutation, CreateYoutubeConnectionMutationVariables>;
export const AccountConnectionsDocument = new TypedDocumentString(`
    query AccountConnections($first: Int, $last: Int, $before: Cursor, $after: Cursor, $where: AccountConnectionWhereInput) {
  accountConnections(
    first: $first
    last: $last
    before: $before
    ...
    `) as unknown as TypedDocumentString<AccountConnectionsQuery, AccountConnectionsQueryVariables>;
export const ImportedVideoDocument = new TypedDocumentString(`
  ...
  node(id: $id) {
    ...
    `) as unknown as TypedDocumentString<ImportedVideoQuery, ImportedVideoQueryVariables>;
export const AccountConnectionDocument = new TypedDocumentString(`
  ...
  node(id: $id) {
    ...
    `) as unknown as TypedDocumentString<AccountConnectionQuery, AccountConnectionQueryVariables>;
export const CreatePostFromImportedVideoDocument = new TypedDocumentString(`
...
export const RefreshInstagramConnectionDocument = new TypedDocumentString(`
  ...
  refreshInstagramConnection(id: $id) {
    ...
    `) as unknown as TypedDocumentString<RefreshInstagramConnectionMutation, RefreshInstagramConnectionMutationVariables>;
export const RefreshTiktokConnectionDocument = new TypedDocumentString(`
    mutation RefreshTiktokConnection($id: Int!) {
  refreshTiktokConnection(id: $id) {
    id
  }
}
    `) as unknown as TypedDocumentString<RefreshTiktokConnectionMutation, RefreshTiktokConnectionMutationVariables>;
export const RefreshYoutubeConnectionDocument = new TypedDocumentString(`
    mutation RefreshYoutubeConnection($id: Int!) {
  refreshYoutubeConnection(id: $id) {
    id
  }
}
    `) as unknown as TypedDocumentString<RefreshYoutubeConnectionMutation, RefreshYoutubeConnectionMutationVariables>;
export const CreatePostsFromConnectionDocument = new TypedDocumentString(`
